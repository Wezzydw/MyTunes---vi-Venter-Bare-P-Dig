...
public class Search {
    ...
    /**
     * Søger listen af sange igennem for input: title, author, categori,
     * releaseyear eller album. hvis inputtet er fundet, returnere den elementer
     * fra listen, der matcher input.
     */
